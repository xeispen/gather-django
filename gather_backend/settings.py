"""
Django settings for gather_backend project.
...
ALLOWED_HOSTS = ['0.0.0.0','192.168.1.120','172.20.10.5']
...
AUTH_USER_MODEL = 'gather_api.User'
...
INSTALLED_APPS = [
    ...
    'gather_api.apps.GatherApiConfig',
    'rest_framework',
...
WSGI_APPLICATION = 'gather_backend.wsgi.application'
